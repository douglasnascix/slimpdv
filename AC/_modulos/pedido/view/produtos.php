...
?>
<h3><?php echo $pedido['pedido_id']?></h3>
<div class="row">
	...
	<table class="table table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td align="right"><button class="btn btn-xs btn-danger pecasExcluir"  id="<?php echo $pedido_produto['pedido_produto_id'].'_'. $pedido_produto['produto_id'].'_'. $pedido_produto['produto_quantidade']?>"><i class="fa fa-ban"></i></button></td>
			</tr>
			<?php };?>
		</tbody>
	</table>
